...
import hashnodeData from '../data/hashnodeUrls.json' assert {type: 'json'};
import blogPostEmbeds from '../data/embeddedPostsMarkup.json' assert {type: 'json'};
import twitterEmbeds from '../data/twitterEmbeds.json' assert {type: 'json'};
...
type BlogPostUrl = keyof typeof blogPostEmbeds

async function updateTwitterEmbeds(twitterEmbeds: TwitterEmbeds, filepath: string) {
 ...
 */
export function boostLink(title, fileSlug, url, canonicalUrl) {
 ...
 */
export async function youtubeEmbed(videoUrl: string) {
  let videoId;
  let time;
 ...
 *
 * @param googleAnalyticsId A Google Analytics ID
 * @param isProduction Whether or not the application is being built for production or not.
 *
 ...
 */
export function socialImage(title: string, excerpt = '') {
 ...
 * @param episodeId
 *
 * @returns Markup for the Buzzsprout podcast episode embed.
 */
async function buzzsproutEmbed(episodeUrl: string, episodeId: string) {
 ...
 *
 * @returns Markup for the Twitter embed.
 */

// generate the type for the keys of the TwitterEmbeds type
export async function twitterEmbed(tweetId: TweetId) {
 ...
 *
 * @param blogPostUrl A dev.to URL
 *
 * @returns Markup for the dev.to link embed.
 */
export function devLinkEmbed(blogPostUrl: BlogPostUrl) {
  const {
    url: devToUrl,
    title,
    published_timestamp,
 ...
 *
 * @returns Markup for the GitHub embed.
 */
export function githubEmbed(url: string) {
 ...
 *
 * @param postId An Instagram post ID
 *
 * @returns Markup for the Instagram embed.
 */
export function instagramEmbed(postId: string) {
  return `<iframe
 ...
 *
 * @param sandboxId A CodeSandbox ID.
 *
 * @returns Markup for the CodeSandbox embed.
 */
export function codeSandboxEmbed(sandboxId: string) {
 ...
 *
 * @param videoId A Twitch video ID.
 *
 * @returns Markup for the Twitch embed.
 */
function twitchEmbed(videoId: string) {
 ...
 * @returns Markup for the Twitch embed.
 */
function vimeoEmbed(videoId: string) {
